...
/** Extended Event interface with additional fields from API response */
...
/** Extended EventParam interface with additional fields from API response */
...
function EventDetail(): React.JSX.Element {
  ...
  // Parallel loading: event data and parameters data
