...
function AlterSqlBuilder(): React.JSX.Element {
  ...
  useEffect(() => {
    const fetchAlterSql = async () => {
      ...
      try {
        ...
        const result: AlterSqlResponse = await response.json();
...
export default memo(AlterSqlBuilder);
