 ...
 * ```ts
 * const id = generateId();
 * console.log(id); // "1707654321098-abc123xyz"
 * ```
 */
 ...
 * console.log(hql);
 * // "-- HQL View Generated by Field Builder
 * // CREATE OR REPLACE VIEW dwd_login_di AS
 * // SELECT
 * //     userId
 * // FROM ieu_ods.ods_login_all_view
 * // WHERE ds = '${bizdate}';"
 * ```
 */
 ...
 * console.log(errors); // ["字段名不能为空", "字段别名不能为空"]
 *
