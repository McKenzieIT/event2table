...
export interface BindToLibraryModalProps {
  paramId: number;
  paramName: string;
  templateId: number;
  onClose: () => void;
...
export function BindToLibraryModal({
  paramId,
  paramName,
  templateId,
  onClose,
  onSuccess
}: BindToLibraryModalProps) {
  const [matchedParams, setMatchedParams] = useState<LibraryParam[]>([]);
