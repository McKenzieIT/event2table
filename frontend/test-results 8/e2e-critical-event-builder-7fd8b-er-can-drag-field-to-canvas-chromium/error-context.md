    ...
    - navigation "面包屑导航" [ref=e90]:
      - list [ref=e91]:
        - listitem [ref=e92]:
          ...
          - text: /
        - listitem [ref=e95]:
          - generic [ref=e96]: 事件节点构建器
    - generic [ref=e97]:
      - heading "请先选择游戏" [level=2] [ref=e98]
      - paragraph [ref=e99]: 事件节点构建器需要游戏上下文才能正常工作
      - button "前往选择游戏" [ref=e100] [cursor=pointer]:
        - generic [ref=e101]: 前往选择游戏
```