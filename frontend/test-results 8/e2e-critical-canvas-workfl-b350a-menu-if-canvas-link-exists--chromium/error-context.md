  ...
  - complementary [ref=e5]:
    ...
    - generic [ref=e13]:
      ...
      - generic [ref=e40]:
        ...
        - list [ref=e46]:
          - listitem [ref=e47]:
            - link " HQL构建画布" [active] [ref=e48] [cursor=pointer]:
              - /url: "#/canvas"
              - generic [ref=e49]: 
    ...
    - navigation "面包屑导航" [ref=e90]:
      - list [ref=e91]:
        - listitem [ref=e92]:
          ...
          - text: /
        - listitem [ref=e95]:
          - generic [ref=e96]: HQL画布
    - generic [ref=e97]:
      - heading "加载失败" [level=2] [ref=e98]
      - paragraph [ref=e99]: 请先选择游戏
      - button "重试" [ref=e100] [cursor=pointer]:
        - generic [ref=e101]: 重试
      - button "返回" [ref=e102] [cursor=pointer]:
        - generic [ref=e103]: 返回
```