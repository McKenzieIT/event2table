    ...
    - navigation "面包屑导航" [ref=e90]:
      - list [ref=e91]:
        - listitem [ref=e92]:
          ...
          - text: /
        - listitem [ref=e95]:
          - generic [ref=e96]: games
    - generic [ref=e99]:
      - generic [ref=e100]: "404"
      - heading "页面未找到" [level=1] [ref=e101]
      - paragraph [ref=e102]: 抱歉，您访问的页面不存在。
      - generic [ref=e103]:
        - button "返回首页" [ref=e104] [cursor=pointer]:
          - generic [ref=e105]:
            - generic [ref=e106]: 
            - text: 返回首页
        - button "游戏管理" [ref=e107] [cursor=pointer]:
          - generic [ref=e108]:
            - generic [ref=e109]: 
            - text: 游戏管理
      - generic [ref=e110]:
        - paragraph [ref=e111]: 需要帮助？
        - list [ref=e112]:
          - listitem [ref=e113]: →检查URL拼写是否正确
          - listitem [ref=e114]: →使用导航菜单浏览可用页面
          - listitem [ref=e115]: →联系管理员报告此问题
```