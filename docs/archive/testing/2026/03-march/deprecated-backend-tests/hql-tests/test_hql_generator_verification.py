...
def test_event_creation_with_alias():
    ...
    try:
        ...
        event = Event(name="login", table_name="ieu_ods.ods_10000147_all_view", alias="e1")
...
def test_hql_generator_join_mode():
    ...
    try:
        ...
        try:
            event_a = Event(name="login_a", table_name="ieu_ods.ods_10000147_all_view", alias="a")
            event_b = Event(name="login_b", table_name="ieu_ods.ods_10000148_all_view", alias="b")
        except TypeError as e:
            if "alias" in str(e):
