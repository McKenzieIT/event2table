...
def test_union_mode():
    ...
    request_data = {
        "game_gid": "10000147",
        "events": [{"event_id": 1}, {"event_id": 2}],  # login  # logout
...
def test_with_where_conditions():
    ...
    request_data = {
        ...
        "where_conditions": [{"field": "zone_id", "operator": "=", "value": 1, "logicalOp": "AND"}],
        "options": {"mode": "single"},
    }
...
def test_error_handling():
    ...
    request_data = {
        "events": [{"game_gid": 10000147, "event_id": 99999}],  # Non-existent event
        "fields": [{"fieldName": "role_id", "fieldType": "base"}],
        "options": {"mode": "single"},
    }
