...
> **🚨 2026-03-08 新增**: 禁止因token或时间限制进行简化或留空实现

**核心理念**：
> **"宁可少做，不可做半"** - 宁可只实现1个完整功能，不做3个半成品功能
...
**文档层面**：
- ✅ 公共API必须有docstring
- ✅ 复杂函数（>10行或包含逻辑分支）必须有docstring
- ✅ 复杂逻辑必须有注释说明WHY（为什么），而非WHAT（做什么）

#### Token/时间限制时的处理

**当资源即将耗尽时**（token使用率>85%或时间不足50%）：
1. **主动告知用户**：提供当前进度、剩余资源、3个选项（继续/分阶段/调整范围）
2. **质量优先**：宁可少做功能，不降低质量标准
3. **透明交付**：明确说明哪些功能已完成、哪些需要后续迭代
...
📖 **完整设计文档**: [docs/plans/2026-03-08-complete-implementation-principle-design.md](docs/plans/2026-03-08-complete-implementation-principle-design.md)
...
- [前端加载问题修复报告](docs/archive/2026/03-march/reports/2026-03-04/COMPLETE-FIX-SUMMARY.md)
...
| **🛡️ XSS防护实施** | [安全要点 - XSS防护实施](docs/lessons-learned/security-essentials.md#xss防护实施) | P0 🆕 |
| **🔐 权限检查完整性** | [安全要点 - 权限检查完整性](docs/lessons-learned/security-essentials.md#权限检查完整性) | P0 🆕 |
| **🐍 Pydantic validator最佳实践** | [Python开发 - Pydantic validator](docs/lessons-learned/python-development.md#pydantic-validator最佳实践) | P0 🆕 |
| **🧪 E2E测试失败** | [测试指南 - E2E测试](docs/lessons-learned/testing-guide.md#e2e测试) | P0 |
| **🧪 TDD Red阶段经验** | [测试指南 - TDD Red阶段](docs/lessons-learned/testing-guide.md#tdd-red阶段经验) | P0 🆕 |
...
| **🔧 TypeScript迁移** | [TypeScript迁移 - Apollo 3.x兼容](docs/lessons-learned/typescript-migration.md) | P0 🆕 |
| **🔒 Security Integration测试** | [Security Integration Testing - 85%通过率](docs/lessons-learned/security-integration-testing.md) | P0 🆕 |
| **🎯 Mutation业务逻辑** | [Mutation Business Logic - 5层验证](docs/lessons-learned/mutation-business-logic.md) | P0 🆕 |
| **🔄 测试修复迭代** | [Test-Fix Iteration - TDD方法论](docs/lessons-learned/test-fix-iteration.md) | P0 🆕 |
...
- **[部署与运维](docs/lessons-learned/deployment-operations.md)** - 部署流程、运维监控、故障排查
- **[TypeScript迁移](docs/lessons-learned/typescript-migration.md)** - Apollo Client 3.x兼容性、类型重复定义、Template Literal错误修复 🆕
- **[Security Integration Testing](docs/lessons-learned/security-integration-testing.md)** - SQL注入防护、XSS攻击检测、白名单验证、85%测试通过率 🆕
- **[Mutation Business Logic](docs/lessons-learned/mutation-business-logic.md)** - 5层验证架构、完整实现原则、安全加固、缓存失效策略 🆕
- **[Test-Fix Iteration](docs/lessons-learned/test-fix-iteration.md)** - 4轮迭代模式、TDD + 并行执行、自动化验证、从20%到100%提升 🆕

### 经验文档使用说明

**为什么建立经验文档系统**：
- ✅ 整合了1009个文档的精华经验，避免重复 (+40个新经验点，2026-03-09更新)
- ✅ 文档减少59%，经验整合率提升到95%+
- ✅ 集中管理，便于查找和维护
- ✅ 持续更新，每次问题修复后立即更新

**最新更新 (2026-03-11)**：
- 🆕 **TypeScript迁移**: Apollo Client 3.x兼容性、类型重复定义解决方案、Template Literal语法错误修复 (1个新文档)
- 🆕 **Security Integration**: SQL注入防护、XSS攻击检测、白名单验证策略、测试通过率从20%提升到85% (1个新文档)
- 🆕 **Mutation Business Logic**: 5层验证架构、完整实现原则、安全加固、缓存失效策略 (1个新文档)
- 🆕 **Test-Fix Iteration**: 4轮迭代模式、TDD + 并行执行策略、自动化验证流程、从20%提升到100% (1个新文档)
- 🆕 **总计**: 4个新P0经验文档（基于184个3月报告的25个关键经验主题）
...
**详细信息**: [Entity迁移状态报告](docs/archive/2026-02/reports/2026-02-26/ENTITY-MIGRATION-STATUS.md)
...
- **[Agent Browser Testing]**([docs/lessons-learned/agent-browser-testing.md])
- **[Api Design Patterns]**([docs/lessons-learned/api-design-patterns.md])
- **[Code Quality Improvement]**([docs/lessons-learned/code-quality-improvement.md])
- **[Database Patterns]**([docs/lessons-learned/database-patterns.md])
- **[Debugging Skills]**([docs/lessons-learned/debugging-skills.md])
- **[Deployment Operations]**([docs/lessons-learned/deployment-operations.md])
- **[Document Management]**([docs/lessons-learned/document-management.md])
- **[Event Node Builder Errors]**([docs/lessons-learned/event-node-builder-errors.md])
- **[Graphql Field Completeness]**([docs/lessons-learned/graphql-field-completeness.md])
- **[Mutation Business Logic]**([docs/lessons-learned/mutation-business-logic.md])
- **[Mypy Compliance]**([docs/lessons-learned/mypy-compliance.md])
...
- **[Refactoring Checklist]**([docs/lessons-learned/refactoring-checklist.md])
- **[Repository Migration]**([docs/lessons-learned/repository-migration.md])
- **[Root Cleanup 2026 03 20]**([docs/lessons-learned/root-cleanup-2026-03-20.md])
- **[Security Essentials]**([docs/lessons-learned/security-essentials.md])
- **[Security Integration Testing]**([docs/lessons-learned/security-integration-testing.md])
- **[Service Architecture]**([docs/lessons-learned/service-architecture.md])
- **[Test Fix Iteration]**([docs/lessons-learned/test-fix-iteration.md])
