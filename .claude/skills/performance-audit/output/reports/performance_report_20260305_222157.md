...
- **Severity**: LOW
- **File**: `/Users/mckenzie/Documents/event2table/frontend/src/analytics/pages/ParameterDashboard.tsx`
- **Message**: Exported component "ParameterDashboard" without React.memo
- **Suggestion**: Consider wrapping: export default React.memo(ParameterDashboard)

#### Exported Component Without Memo
- **Severity**: LOW
- **File**: `/Users/mckenzie/Documents/event2table/frontend/src/analytics/pages/ValidationRules.tsx`
- **Message**: Exported component "ValidationRules" without React.memo
- **Suggestion**: Consider wrapping: export default React.memo(ValidationRules)

#### Exported Component Without Memo
- **Severity**: LOW
- **File**: `/Users/mckenzie/Documents/event2table/frontend/src/analytics/pages/LogDetail.tsx`
- **Message**: Exported component "LogDetail" without React.memo
- **Suggestion**: Consider wrapping: export default React.memo(LogDetail)
...
- **Message**: Exported component "EventManagementModalGraphQL" without React.memo
- **Suggestion**: Consider wrapping: export default React.memo(EventManagementModalGraphQL)
...
#### Exported Component Without Memo
- **Severity**: LOW
- **File**: `/Users/mckenzie/Documents/event2table/frontend/src/features/games/AddGameModalGraphQL.tsx`
- **Message**: Exported component "AddGameModalGraphQL" without React.memo
- **Suggestion**: Consider wrapping: export default React.memo(AddGameModalGraphQL)
...
1. **Fix 17 exported_component_without_memo issues**
