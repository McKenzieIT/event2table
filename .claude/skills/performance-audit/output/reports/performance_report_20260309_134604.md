...
- **High Priority**: 538 issue(s)
- **Medium Priority**: 34 issue(s)
- **Low Priority**: 27 issue(s)
...
- **Message**: Array methods found (2 .map, 2 .filter, 0 .reduce) without useMemo
- **Suggestion**: If processing large datasets, wrap computation in useMemo: const result = useMemo(() => data.map(...), [data])
...
- **Message**: Large component file (3649 chars) without React.memo
...
- **Message**: Large component file (4363 chars) without React.memo
- **Suggestion**: Consider wrapping with React.memo to prevent unnecessary re-renders
...
- **Message**: Array methods found (8 .map, 2 .filter, 0 .reduce) without useMemo
- **Suggestion**: If processing large datasets, wrap computation in useMemo: const result = useMemo(() => data.map(...), [data])
...
#### Potential N Plus 1 Query
- **Severity**: HIGH
- **File**: `/Users/mckenzie/Documents/event2table/backend/services/events/event_builder_app_service.py`
- **Message**: Possible N+1 query detected: database query inside loop
- **Suggestion**: Use eager loading (JOIN) or prefetch to avoid N+1 queries
...
#### Potential N Plus 1 Query
- **Severity**: HIGH
- **File**: `/Users/mckenzie/Documents/event2table/backend/gql_api/mutations/batch_mutations.py`
- **Message**: Possible N+1 query detected: database query inside loop
- **Suggestion**: Use eager loading (JOIN) or prefetch to avoid N+1 queries
...
- **Severity**: MEDIUM
- **File**: `/Users/mckenzie/Documents/event2table/backend/gql_api/dataloaders/parameter_loader_enhanced.py`
...
#### Potential N Plus 1 Query
- **Severity**: HIGH
- **File**: `/Users/mckenzie/Documents/event2table/backend/test/unit/security/test_error_message_leak.py`
- **Message**: Possible N+1 query detected: database query inside loop
- **Suggestion**: Use eager loading (JOIN) or prefetch to avoid N+1 queries

#### Potential N Plus 1 Query
- **Severity**: HIGH
- **File**: `/Users/mckenzie/Documents/event2table/backend/test/unit/security/test_sql_injection_protection.py`
- **Message**: Possible N+1 query detected: database query inside loop
- **Suggestion**: Use eager loading (JOIN) or prefetch to avoid N+1 queries
...
#### Potential N Plus 1 Query
- **Severity**: HIGH
- **File**: `/Users/mckenzie/Documents/event2table/backend/test/unit/performance/test_batch_operations.py`
- **Message**: Possible N+1 query detected: database query inside loop
- **Suggestion**: Use eager loading (JOIN) or prefetch to avoid N+1 queries

#### Potential N Plus 1 Query
- **Severity**: HIGH
- **File**: `/Users/mckenzie/Documents/event2table/backend/test/unit/performance/test_n1_query_detection.py`
- **Message**: Possible N+1 query detected: database query inside loop
- **Suggestion**: Use eager loading (JOIN) or prefetch to avoid N+1 queries

#### Potential N Plus 1 Query
- **Severity**: HIGH
- **File**: `/Users/mckenzie/Documents/event2table/backend/test/unit/performance/test_field_usage_performance.py`
- **Message**: Possible N+1 query detected: database query inside loop
- **Suggestion**: Use eager loading (JOIN) or prefetch to avoid N+1 queries
...
1. **Fix 538 potential_n_plus_1_query issues**

1. **Fix 30 missing_cache_decorator issues**

1. **Fix 15 potential_missing_usememo issues**

1. **Fix 9 exported_component_without_memo issues**

1. **Fix 4 missing_react_memo issues**
