...
def test_bloom_filter_enhanced_import():
    """测试布隆过滤器模块导入"""
    from core.cache.bloom_filter_enhanced import EnhancedBloomFilter, get_enhanced_bloom_filter
...
def test_monitoring_import():
    """测试监控告警模块导入"""
    from core.cache.monitoring import CacheAlertManager, cache_alert_manager
...
def test_capacity_monitor_import():
    """测试容量监控模块导入"""
    from core.cache.capacity_monitor import (
...
def test_consistency_import():
    """测试读写锁模块导入"""
    from core.cache.consistency import CacheReadWriteLock, cache_rw_lock
...
def test_degradation_import():
    """测试降级策略模块导入"""
    from core.cache.degradation import CacheDegradationManager, cache_degradation_manager
...
def test_intelligent_warmer_import():
    """测试智能预热模块导入"""
    from core.cache.intelligent_warmer import IntelligentCacheWarmer, intelligent_cache_warmer
