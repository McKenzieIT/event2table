...
class TestReadWriteLockIntegration:
    ...
    def test_read_lock_basic(self):
        """测试基本读锁功能"""
        cache = HierarchicalCache(l1_size=100, enable_read_write_lock=True)
    ...
    def test_read_write_lock_toggle(self):
        """测试读写锁开关"""
        cache = HierarchicalCache(l1_size=100, enable_read_write_lock=False)
...
class TestBloomFilterIntegration:
    ...
    def test_bloom_filter_basic(self):
        """测试基本布隆过滤器功能"""
        cache = HierarchicalCache(l1_size=100, enable_bloom_filter=True)
    ...
    def test_bloom_filter_toggle(self):
        """测试布隆过滤器开关"""
        cache = HierarchicalCache(l1_size=100, enable_bloom_filter=False)
...
class TestDegradationIntegration:
    ...
    def test_degradation_basic(self):
        """测试基本降级功能"""
        cache = HierarchicalCache(l1_size=100, enable_degradation=True)
    ...
    def test_degradation_toggle(self):
        """测试降级策略开关"""
        cache = HierarchicalCache(l1_size=100, enable_degradation=False)
...
class TestMultipleIntegrations:
    ...
    def test_read_write_with_bloom_filter(self):
        """测试读写锁 + 布隆过滤器"""
        cache = HierarchicalCache(
            l1_size=100, enable_read_write_lock=True, enable_bloom_filter=True
        )
    ...
    def test_read_write_with_degradation(self):
        """测试读写锁 + 降级策略"""
        cache = HierarchicalCache(l1_size=100, enable_read_write_lock=True, enable_degradation=True)
