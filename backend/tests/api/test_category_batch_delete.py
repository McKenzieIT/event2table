...
class TestCategoryBatchDelete:
    ...
    def test_batch_delete_with_events(self, client):
        ...
        response = client.post(
            '/api/categories', json={'name': 'Category with Events', 'name_cn': '带事件的分类'}
        )
    ...
    def test_batch_delete_mixed(self, client):
        ...
        response = client.delete(
            '/api/categories/batch', json={'ids': [99999, 100000]}  # Non-existent IDs
        )
    ...
    def test_api_batch_delete_with_events(self, client):
        ...
        response = client.post('/api/categories', json={'name': 'Test Category', 'name_cn': '测试分类'})
