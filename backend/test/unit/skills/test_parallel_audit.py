...
class TestSubagentTask:
    ...
    def test_task_creation(self):
        ...
        task = SubagentTask(task_id="test_task", detector=detector, file_path="/fake/path.py")
...
class TestSubagentManager:
    ...
    def test_manager_initialization(self):
        ...
        manager = SubagentManager(max_workers=2, timeout=60, enable_progress=False)
    ...
    def test_create_tasks(self):
        ...
        detectors = [MockDetector("detector1", delay=0.05), MockDetector("detector2", delay=0.05)]
    ...
    def test_parallel_execution(self):
        ...
        detectors = [MockDetector("detector1", delay=0.1), MockDetector("detector2", delay=0.1)]
...
class TestParallelAuditRunner:
    ...
    def test_runner_initialization(self):
        ...
        runner = ParallelAuditRunner(max_workers=4, timeout=300, enable_progress=True)
    ...
    def test_progress_callback(self):
        ...
        issues = runner.run_parallel_audit(detectors, file_paths, progress_callback=callback)
