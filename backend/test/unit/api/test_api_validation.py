...
class TestAPIParameterValidation(unittest.TestCase):
    ...
    def test_create_event_missing_required_field(self):
        ...
        response = self.client.post(
            "/api/events", data=json.dumps(incomplete_event), content_type="application/json"
        )
    ...
    def test_create_event_invalid_game_id(self):
        ...
        response = self.client.post(
            "/api/events", data=json.dumps(invalid_event), content_type="application/json"
        )
    ...
    def test_create_event_invalid_json(self):
        ...
        response = self.client.post(
            "/api/events", data="{invalid json}", content_type="application/json"
        )
