...
class TestValidationFunctions:
    ...
    def test_validate_json_request_success(self):
        ...
        with app.test_request_context(json={"key": "value"}, content_type="application/json"):
    ...
    def test_validate_json_request_missing_field(self):
        ...
        with app.test_request_context(json={"other": "value"}, content_type="application/json"):
            is_valid, data, error = validate_json_request(["key"])
