...
class TestEnvironmentDetection:
    ...
    def test_default_environment_returns_production_db(self):
        ...
        # 应该返回生产数据库路径 (data/dwd_generator.db)
        assert db_path == BASE_DIR / "data" / "dwd_generator.db"
    ...
    def test_testing_environment_returns_test_db(self):
        ...
        # 应该返回测试数据库路径 (data/test_database.db)
        assert db_path == BASE_DIR / "data" / "test_database.db"
    ...
    def test_development_environment_returns_dev_db(self):
        ...
        # 应该返回开发数据库路径 (data/dwd_generator_dev.db)
        assert db_path == BASE_DIR / "data" / "dwd_generator_dev.db"
    ...
    def test_environment_case_insensitive(self):
        ...
        # 应该正确处理大小写 (data/test_database.db)
        assert db_path == BASE_DIR / "data" / "test_database.db"
