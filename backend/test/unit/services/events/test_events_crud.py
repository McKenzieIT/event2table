...
class TestEventBuilder:
    ...
    def test_build_missing_game_gid(self):
        ...
        builder = EventBuilder().set_names("login", "登录").set_category(1)
    ...
    def test_build_missing_event_name(self):
        ...
        builder = EventBuilder().set_game(10000147, "ieu_ods").set_category(1)
    ...
    def test_build_missing_event_name_cn(self):
        ...
        builder = (
            EventBuilder().set_game(10000147, "ieu_ods").set_names("login", None).set_category(1)
        )
    ...
    def test_build_missing_category_id(self):
        ...
        builder = EventBuilder().set_game(10000147, "ieu_ods").set_names("login", "登录")
    ...
    def test_build_table_names_with_ieu_ods(self):
        ...
        builder = (
            EventBuilder().set_game(10000147, "ieu_ods").set_names("login", "登录").set_category(1)
        )
