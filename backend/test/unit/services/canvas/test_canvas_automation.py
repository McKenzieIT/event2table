...
class CanvasIntegrationTest:
    ...
    def test_node_canvas_js_accessible(self):
        ...
        assert (
            'const NodeCanvas' in content or 'var NodeCanvas' in content
        ), "NodeCanvas declaration not found"
    ...
    def test_integration_test_suite_loaded(self):
        ...
        response = requests.get(
            f"{self.base_url}/static/tests/canvas-integration-test.js", timeout=5
        )
        assert response.status_code == 200, f"Expected 200, got {response.status_code}"
    ...
    def test_api_endpoints_accessible(self):
        ...
        endpoints = ['/api/canvas/flows', '/api/canvas/nodes', '/api/events', '/api/games']
