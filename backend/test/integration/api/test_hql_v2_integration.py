...
class TestHQLV2PreviewAPI:
    ...
    def test_preview_hql_returns_valid_response(self, hql_v2_test_data):
        ...
        request_data = {
            ...
            "fields": [{"name": "ds", "type": "base"}, {"name": "role_id", "type": "base"}],
            "filter_conditions": {},
        }
    ...
    def test_preview_hql_with_conditions(self, hql_v2_test_data):
        ...
        request_data = {
            "game_gid": hql_v2_test_data["game_gid"],
            "event_id": hql_v2_test_data["event_id"],  # 使用实际存在的事件ID
            "fields": [{"name": "role_id", "type": "base"}],
            "filter_conditions": {
                "conditions": [{"field": "role_id", "operator": "=", "value": 123}]
            },
        }
    ...
    def test_preview_hql_with_param_field(self, hql_v2_test_data):
        """
        RED: 测试带参数字段的HQL预览
    ...
    def test_preview_hql_generates_correct_view_name(self, hql_v2_test_data):
        """
        RED: 测试生成的HQL使用正确的表名
        ...
        # 验证HQL包含正确的表名(使用fixture提供的测试GID)
        hql = data['data']['hql_content']
        expected_table = f'FROM ieu_ods.ods_{hql_v2_test_data["game_gid"]}_all_view'
        assert expected_table in hql
...
class TestHQLV2Validation:
    ...
    def test_validates_field_structure(self, hql_v2_test_data):
        """
        RED: 测试字段结构验证
    ...
    def test_validates_condition_operators(self, hql_v2_test_data):
        """
        RED: 测试条件操作符验证
        ...
        request_data = {
            ...
            "fields": [{"name": "role_id", "type": "base"}],
            "filter_conditions": {
                "conditions": [{"field": "role_id", "operator": "INVALID", "value": 123}]
            },
        }
...
class TestHQLV2Performance:
    ...
    def test_preview_hql_performance_with_large_fields(self, hql_v2_test_data):
        """
        RED: 测试大量字段的性能
        ...
        """
        # 生成50个字段
        fields = [{"name": f"field_{i}", "type": "base"} for i in range(50)]
